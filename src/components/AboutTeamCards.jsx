...
function AboutTeamCards({image, title, description}) {
  return (
       ...
       <div className='flex flex-col items-center cursor-pointer hover:translate-y-[-5px] duration-300 justify-center shadow-2xl shadow-gray-900 gap-2 rounded-2xl shadow-3xl shadow-[gray-500] w-[90%] md:w-[30%] text-white p-5 bg-[#234C6A]'>
