  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full bg-transparent">
      <nav className="flex items-center justify-between px-6 md:px-16 py-5">
        ...
        <div
          className={`fixed md:static top-0 left-0 z-40 flex flex-col md:flex-row
          items-center justify-center gap-8 md:gap-10
          w-full md:w-auto h-screen md:h-auto
          px-6 md:px-10 py-5 font-medium text-lg md:text-base
          bg-black/70 md:bg-white/10 backdrop-blur-xl
          border md:border border-gray-300/20 md:rounded-full
