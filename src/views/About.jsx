  ...
  return (
    <div className='bg-[#1B3C53] min-h-screen p-[0.1px] box-border'>
     ...
     <div className='w-full p-5'>
       <div className='flex flex-col md:flex-row my-10 w- rounded-2xl shadow-2xl bg-[#234C6A] w-full items-center justify-center shadow-2xl shadow-gray-900 p-5 gap-5'>
