...
function About() {
  ...
  return (
    <div className='bg-[#1B3C53] min-h-screen p-5 box-border'>
      ...
      <div className='flex flex-col md:flex-row my-10 rounded-2xl bg-[#234C6A] w-full items-center justify-center p-5 gap-5'>
